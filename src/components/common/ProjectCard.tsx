...
export default function ProjectCard({ project }: ProjectCardProps) {
  const { id, title, description, tags, thumbnail, status } = project;
  ...
  return (
    <Card 
      className="project-card-hover group flex flex-col h-full surface-base overflow-hidden cursor-pointer"
